...
# =============================================================================
# Este archivo es una PIEZA del Sistema de Estudio: guarda los colores, medidas y rutas
...
if __name__ == "__main__":
    print("")
    print("  Este archivo (configuracion.py) es una pieza del Sistema de Estudio.")
