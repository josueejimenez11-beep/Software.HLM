...
# Pillow es opcional: si esta instalado, permite cargar el logo en formatos
# adicionales (JPG/JPEG) ademas de PNG. Si no esta disponible, el programa
# sigue funcionando normalmente y solo podra leer PNG con tk.PhotoImage.
try:
